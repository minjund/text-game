<template>
  <div class="main-page">
    ...
    <div class="kingdom-info-grid">
      ...
      <!-- 왕국 정보 (중앙/모바일에서는 상단 왼쪽) - 대전쟁 타이머 + 패시브 카드 -->
...
.kingdom-banner {
  ...
  box-shadow:
    ...
    inset 0 2px 0 rgba(100, 116, 139, 0.4);
  display: flex;
...
@media (max-width: 768px) {
  ...
  .kingdom-info-grid {
    flex: 1;
    display: grid;
    grid-template-columns: 1fr 140px; /* 왼쪽: 왕국정보, 오른쪽: 재화 */
    grid-template-rows: 1fr auto; /* 상단: 정보+재화, 하단: 왕명선택 */
    gap: 5px;
    padding: 5px;
    border-radius: 0;
    overflow: hidden;
